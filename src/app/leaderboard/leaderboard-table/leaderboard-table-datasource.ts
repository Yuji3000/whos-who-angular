...
export class LeaderboardTableDataSource extends DataSource<LeaderboardTableItem> {
  ...
  constructor(data: LeaderboardTableItem[]) {
    super();
    this.data = data;
  }
   ...
   */
  private getPagedData(data: LeaderboardTableItem[]): LeaderboardTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: LeaderboardTableItem[]): LeaderboardTableItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'questionsAnswered': return compare(+a.questionsAnswered, +b.questionsAnswered, isAsc);
